...
from feature_format import featureFormat, targetFeatureSplit, FeatureScaling
import os
...
pred = KMeans(n_clusters=2, random_state=0)
...
try:
   Draw(pred.labels_, finance_features, poi, mark_poi=False, name="clusters.pdf", f1_name=feature_1, f2_name=feature_2)
    #Draw(pred.labels_, finance_features, poi, mark_poi=False, name="clusters.pdf", f1_name=feature_1, f2_name=feature_2, f3_name=feature_3)
except NameError:
